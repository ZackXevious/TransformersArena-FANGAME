...
public class CharacterBuilder : MonoBehaviour {
    ...
    public void setHelmet(float value) {
        gcScript.setHelmetModel((int)value % CharLoader.getNumHelmets());
        CharLoader.SpawnHelmet();
    }
    public void setVisor(float value) {
        gcScript.setVisorModel((int)value % CharLoader.getNumVisors());
        CharLoader.SpawnVisor();
    }
    public void setMouthplate(float value) {
        gcScript.setMouthPlateModel((int)value % CharLoader.getNumMouthplates());
        CharLoader.SpawnMouthPiece();
    }
